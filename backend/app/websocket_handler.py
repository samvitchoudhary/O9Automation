...
from app.models import TestStep, ExecutionStatus, TestCase, TestCaseStatus, TestStepStatus
...
async def handle_generate_test_case(websocket: WebSocket, description: str, db: Session):
    ...
    This avoids timeout issues by using WebSocket for long-running operations
    """
    import logging
    logger = logging.getLogger(__name__)
